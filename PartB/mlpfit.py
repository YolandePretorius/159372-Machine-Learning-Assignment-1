...
def mlpfit(pop):
    ...
    index = 0
    testing_in,testing_tgt,train_in,train_tgt =RunMLPPartB.getData()
    for genome in pop:
        ...
        percentAccuracy = RunMLPPartB.runMLP(testing_in,testing_tgt,train_in,train_tgt,weigth1Reshape,weigth2Reshape)
